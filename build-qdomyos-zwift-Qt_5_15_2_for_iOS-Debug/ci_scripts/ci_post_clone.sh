curl -O https://raw.githubusercontent.com/Homebrew/homebrew-core/67e7aa02813056543f2d31dcd643e7418eb329cb/Formula/qt%405.rb -o qt.rb
ls -ltr
brew install --HEAD -s qt.rb
#awk '
