...
INSTANTIATE_TEST_SUITE_P(
    ...
    testing::Values(
        ...
        std::make_tuple(QByteArray::fromHex(
                            "fa05000004008600000000040032000000763c000374ec"),
                        XcxTelemetry{0, 0, 4, 13.4, 0, 4, 50, 0, 118, 60})));
...
TEST(XcxBikeParserRejectionTest, RejectsWrongLengthAndHeaders) {
  ...
  EXPECT_FALSE(xcxbike::parseTelemetry(
      QByteArray::fromHex("fa0504003b00780000000001002e0000006e3c0003"),
      &telemetry));
  EXPECT_FALSE(xcxbike::parseTelemetry(
