...
{
    if(workoutTracking != nil && !appleWatchAppInstalled())
        [workoutTracking addMetricsWithPower:currentWatt cadence:currentCadence speed:normalizeSpeed kcal:currentCalories, bluetoothdevice::BLUETOOTH_TYPE::ROWING];
