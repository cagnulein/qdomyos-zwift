...
{
    if(workoutTracking != nil && !appleWatchAppInstalled())
        [workoutTracking addMetricsWithPower:currentWatt cadence:currentCadence speed:normalizeSpeed kcal:currentCalories steps:0 deviceType: deviceType distance:Distance totalKcal:0 elevationGain:0 heartRate:0];
...
{
    if(workoutTracking != nil && !appleWatchAppInstalled())
        [workoutTracking addMetricsWithPower:currentWatt cadence:currentCadence speed:normalizeSpeed kcal:KCal steps:0 deviceType: deviceType distance:Distance totalKcal:0 elevationGain:0 heartRate:0];
...
{
    if(workoutTracking != nil && !appleWatchAppInstalled()) {
        [workoutTracking addMetricsWithPower:currentWatt cadence:currentCadence speed:normalizeSpeed kcal:currentCalories steps:currentSteps deviceType:deviceType distance:currentDistance totalKcal:0 elevationGain:elevationGain heartRate:0];
    }
