...
{
    const uint8_t res1[] = { 0xff, 0x0d, 0x02, 0x04, 0x02, 0x09, 0x07, 0x09, 0x02, 0x01, 0x04, 0xa3, 0x04, 0x00, 0xbe, 0x00, 0x00, 0x00, 0x00, 0x00 };
    const uint8_t res2[] = { 0xff, 0x0d, 0x02, 0x04, 0x02, 0x09, 0x07, 0x09, 0x02, 0x01, 0x04, 0x14, 0x07, 0x00, 0x32, 0x00, 0x00, 0x00, 0x00, 0x00 };
    const uint8_t res3[] = { 0xff, 0x0d, 0x02, 0x04, 0x02, 0x09, 0x07, 0x09, 0x02, 0x01, 0x04, 0x85, 0x09, 0x00, 0xa5, 0x00, 0x00, 0x00, 0x00, 0x00 };
    const uint8_t res4[] = { 0xff, 0x0d, 0x02, 0x04, 0x02, 0x09, 0x07, 0x09, 0x02, 0x01, 0x04, 0xf6, 0x0b, 0x00, 0x18, 0x00, 0x00, 0x00, 0x00, 0x00 };
    const uint8_t res5[] = { 0xff, 0x0d, 0x02, 0x04, 0x02, 0x09, 0x07, 0x09, 0x02, 0x01, 0x04, 0x67, 0x0e, 0x00, 0x8c, 0x00, 0x00, 0x00, 0x00, 0x00 };
    const uint8_t res6[] = { 0xff, 0x0d, 0x02, 0x04, 0x02, 0x09, 0x07, 0x09, 0x02, 0x01, 0x04, 0xd8, 0x10, 0x00, 0xff, 0x00, 0x00, 0x00, 0x00, 0x00 };
    const uint8_t res7[] = { 0xff, 0x0d, 0x02, 0x04, 0x02, 0x09, 0x07, 0x09, 0x02, 0x01, 0x04, 0x49, 0x13, 0x00, 0x73, 0x00, 0x00, 0x00, 0x00, 0x00 };
    const uint8_t res8[] = { 0xff, 0x0d, 0x02, 0x04, 0x02, 0x09, 0x07, 0x09, 0x02, 0x01, 0x04, 0xba, 0x15, 0x00, 0xe6, 0x00, 0x00, 0x00, 0x00, 0x00 };
    const uint8_t res9[] = { 0xff, 0x0d, 0x02, 0x04, 0x02, 0x09, 0x07, 0x09, 0x02, 0x01, 0x04, 0x2b, 0x18, 0x00, 0x5a, 0x00, 0x00, 0x00, 0x00, 0x00 };
    const uint8_t res10[] = { 0xff, 0x0d, 0x02, 0x04, 0x02, 0x09, 0x07, 0x09, 0x02, 0x01, 0x04, 0x9c, 0x1a, 0x00, 0xcd, 0x00, 0x00, 0x00, 0x00, 0x00 };
    const uint8_t res11[] = { 0xff, 0x0d, 0x02, 0x04, 0x02, 0x09, 0x07, 0x09, 0x02, 0x01, 0x04, 0x0d, 0x1d, 0x00, 0x41, 0x00, 0x00, 0x00, 0x00, 0x00 };
    const uint8_t res12[] = { 0xff, 0x0d, 0x02, 0x04, 0x02, 0x09, 0x07, 0x09, 0x02, 0x01, 0x04, 0x7e, 0x1f, 0x00, 0xb4, 0x00, 0x00, 0x00, 0x00, 0x00 };
    const uint8_t res13[] = { 0xff, 0x0d, 0x02, 0x04, 0x02, 0x09, 0x07, 0x09, 0x02, 0x01, 0x04, 0xef, 0x21, 0x00, 0x27, 0x00, 0x00, 0x00, 0x00, 0x00 };
    const uint8_t res14[] = { 0xff, 0x0d, 0x02, 0x04, 0x02, 0x09, 0x07, 0x09, 0x02, 0x01, 0x04, 0x60, 0x24, 0x00, 0x9b, 0x00, 0x00, 0x00, 0x00, 0x00 };
    const uint8_t res15[] = { 0xff, 0x0d, 0x02, 0x04, 0x02, 0x09, 0x07, 0x09, 0x02, 0x01, 0x04, 0xd1, 0x26, 0x00, 0x0e, 0x00, 0x00, 0x00, 0x00, 0x00 };

    switch (requestResistance) {
    case 1:
        writeCharacteristic((uint8_t*)res1, sizeof(res1), "resistance1");
        break;
    case 2:
        writeCharacteristic((uint8_t*)res2, sizeof(res2), "resistance2");
        break;
    case 3:
        writeCharacteristic((uint8_t*)res3, sizeof(res3), "resistance3");
        break;
    case 4:
        writeCharacteristic((uint8_t*)res4, sizeof(res4), "resistance4");
        break;
    case 5:
        writeCharacteristic((uint8_t*)res5, sizeof(res5), "resistance5");
        break;
    case 6:
        writeCharacteristic((uint8_t*)res6, sizeof(res6), "resistance6");
        break;
    case 7:
        writeCharacteristic((uint8_t*)res7, sizeof(res7), "resistance7");
        break;
    case 8:
        writeCharacteristic((uint8_t*)res8, sizeof(res8), "resistance8");
        break;
    case 9:
        writeCharacteristic((uint8_t*)res9, sizeof(res9), "resistance9");
        break;
    case 10:
        writeCharacteristic((uint8_t*)res10, sizeof(res10), "resistance10");
        break;
    case 11:
        writeCharacteristic((uint8_t*)res11, sizeof(res11), "resistance11");
        break;
    case 12:
        writeCharacteristic((uint8_t*)res12, sizeof(res12), "resistance12");
        break;
    case 13:
        writeCharacteristic((uint8_t*)res13, sizeof(res13), "resistance13");
        break;
    case 14:
        writeCharacteristic((uint8_t*)res14, sizeof(res14), "resistance14");
        break;
    case 15:
        writeCharacteristic((uint8_t*)res15, sizeof(res15), "resistance15");
        break;
    case 16:
        //writeCharacteristic((uint8_t*)res1, sizeof(res1), "resistance1");
        break;
