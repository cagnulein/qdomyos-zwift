/****************************************************************************
** Meta object code from reading C++ file 'chronobike.h'
**
...
#error "The header file 'chronobike.h' doesn't include <QObject>."
...
struct qt_meta_stringdata_chronobike_t {
    QByteArrayData data[32];
    char stringdata0[501];
};
#define QT_MOC_LITERAL(idx, ofs, len) \
    Q_STATIC_BYTE_ARRAY_DATA_HEADER_INITIALIZER_WITH_OFFSET(len, \
    qptrdiff(offsetof(qt_meta_stringdata_chronobike_t, stringdata0) + ofs \
        - idx * sizeof(QByteArrayData)) \
    )
static const qt_meta_stringdata_chronobike_t qt_meta_stringdata_chronobike = {
    {
QT_MOC_LITERAL(0, 0, 10), // "chronobike"
...
QT_MOC_LITERAL(26, 399, 18), // "connection_timeout"
...
QT_MOC_LITERAL(31, 469, 31) // "QLowEnergyService::ServiceError"
    ...
    "chronobike\0disconnected\0\0debug\0string\0"
...
static const uint qt_meta_data_chronobike[] = {
...
void chronobike::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        auto *_t = static_cast<chronobike *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
        ...
        {
            using _t = void (chronobike::*)();
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&chronobike::disconnected)) {
                *result = 0;
                return;
            }
        }
        {
            using _t = void (chronobike::*)(QString );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&chronobike::debug)) {
                *result = 1;
                return;
            }
        }
...
QT_INIT_METAOBJECT const QMetaObject chronobike::staticMetaObject = { {
    QMetaObject::SuperData::link<bike::staticMetaObject>(),
    qt_meta_stringdata_chronobike.data,
    qt_meta_data_chronobike,
    qt_static_metacall,
    nullptr,
    nullptr
} };
...
const QMetaObject *chronobike::metaObject() const
{
    return QObject::d_ptr->metaObject ? QObject::d_ptr->dynamicMetaObject() : &staticMetaObject;
}

void *chronobike::qt_metacast(const char *_clname)
{
    if (!_clname) return nullptr;
    if (!strcmp(_clname, qt_meta_stringdata_chronobike.stringdata0))
        return static_cast<void*>(this);
    return bike::qt_metacast(_clname);
}

int chronobike::qt_metacall(QMetaObject::Call _c, int _id, void **_a)
{
...
// SIGNAL 0
void chronobike::disconnected()
{
    QMetaObject::activate(this, &staticMetaObject, 0, nullptr);
}

// SIGNAL 1
void chronobike::debug(QString _t1)
{
