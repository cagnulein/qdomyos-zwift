...
resistance_t apexbike::pelotonToBikeResistance(int pelotonResistance) {
...
resistance_t apexbike::resistanceFromPowerRequest(uint16_t power) {
...
double apexbike::bikeResistanceToPeloton(double resistance) {
    QSettings settings;
...
uint16_t apexbike::wattsFromResistance(double resistance) {
