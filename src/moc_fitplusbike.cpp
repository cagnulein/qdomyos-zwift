/****************************************************************************
** Meta object code from reading C++ file 'fitplusbike.h'
**
...
#error "The header file 'fitplusbike.h' doesn't include <QObject>."
...
struct qt_meta_stringdata_fitplusbike_t {
    QByteArrayData data[29];
    char stringdata0[470];
};
#define QT_MOC_LITERAL(idx, ofs, len) \
    Q_STATIC_BYTE_ARRAY_DATA_HEADER_INITIALIZER_WITH_OFFSET(len, \
    qptrdiff(offsetof(qt_meta_stringdata_fitplusbike_t, stringdata0) + ofs \
        - idx * sizeof(QByteArrayData)) \
    )
static const qt_meta_stringdata_fitplusbike_t qt_meta_stringdata_fitplusbike = {
    {
QT_MOC_LITERAL(0, 0, 11), // "fitplusbike"
...
QT_MOC_LITERAL(28, 438, 31) // "QLowEnergyService::ServiceError"
    ...
    "fitplusbike\0disconnected\0\0deviceDiscovered\0"
...
static const uint qt_meta_data_fitplusbike[] = {
...
void fitplusbike::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        auto *_t = static_cast<fitplusbike *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
        ...
        {
            using _t = void (fitplusbike::*)();
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&fitplusbike::disconnected)) {
                *result = 0;
                return;
            }
        }
...
QT_INIT_METAOBJECT const QMetaObject fitplusbike::staticMetaObject = { {
    QMetaObject::SuperData::link<bike::staticMetaObject>(),
    qt_meta_stringdata_fitplusbike.data,
    qt_meta_data_fitplusbike,
    qt_static_metacall,
    nullptr,
    nullptr
} };
...
const QMetaObject *fitplusbike::metaObject() const
{
    return QObject::d_ptr->metaObject ? QObject::d_ptr->dynamicMetaObject() : &staticMetaObject;
}

void *fitplusbike::qt_metacast(const char *_clname)
{
    if (!_clname) return nullptr;
    if (!strcmp(_clname, qt_meta_stringdata_fitplusbike.stringdata0))
        return static_cast<void*>(this);
    return bike::qt_metacast(_clname);
}

int fitplusbike::qt_metacall(QMetaObject::Call _c, int _id, void **_a)
{
