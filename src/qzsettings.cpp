...
const QString QZSettings::cadence_sensor_zwift_half = QStringLiteral("cadence_sensor_zwift_half");
...
QVariant allSettings[allSettingsCount][2] = {
    ...
    {QZSettings::cadence_sensor_zwift_half, QZSettings::default_cadence_sensor_zwift_half},
};
