...
const QString QZSettings::target_metrics_range_peloton = QStringLiteral("target_metrics_range_peloton");
...
QVariant allSettings[allSettingsCount][2] = {
    ...
    {QZSettings::target_metrics_range_peloton, QZSettings::default_target_metrics_range_peloton},
};
