...
class QZSettings {
  ...
  public:
    ...
    static const QString garmin_mfa_token;
    static const QString default_garmin_mfa_token;

    static const QString garmin_mfa_expiration_timestamp;
    static constexpr qint64 default_garmin_mfa_expiration_timestamp = 0;
