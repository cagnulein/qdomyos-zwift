...
void fitmetria_fanfit::fanSpeedRequest(uint8_t speed) {
    ...
    if (speed > 102)
        speed = 102;
    double max = settings.value(QZSettings::fitmetria_fanfit_max, QZSettings::default_fitmetria_fanfit_max /* 100 */).toDouble();
    double min = settings.value(QZSettings::fitmetria_fanfit_min, QZSettings::default_fitmetria_fanfit_min /* 0 */).toDouble();
