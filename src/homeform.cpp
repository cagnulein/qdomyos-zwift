...
homeform::homeform(QQmlApplicationEngine *engine, bluetooth *bl) {
    ...
    if (!settings.value(QZSettings::top_bar_enabled, QZSettings::default_top_bar_enabled /* true */).toBool()) {
...
void homeform::keyMediaPrevious() {
    ...
    QSettings settings;
    if (settings.value(QZSettings::volume_change_gears, QZSettings::default_volume_change_gears /* false */).toBool()) {
...
void homeform::sortTiles() {
    ...
    QSettings settings;
    bool pelotoncadence = settings.value(QZSettings::bike_cadence_sensor, QZSettings::default_bike_cadence_sensor /* false */).toBool();
    ...
    if (bluetoothManager->device()->deviceType() == bluetoothdevice::TREADMILL) {
        for (int i = 0; i < 100; i++) {
            if (settings.value(QZSettings::tile_speed_enabled, QZSettings::default_tile_speed_enabled /* true */).toBool() &&
                settings.value(QZSettings::tile_speed_order, QZSettings::default_tile_speed_order /* 0 */).toInt() == i) {

                speed->setGridId(i);
                dataList.append(speed);
            }

            if (settings.value(QZSettings::tile_inclination_enabled, QZSettings::default_tile_inclination_enabled /* true */).toBool() &&
                settings.value(QZSettings::tile_inclination_order, QZSettings::default_tile_inclination_order /* 0 */).toInt() == i) {
                inclination->setGridId(i);
                dataList.append(inclination);
            }

            if (settings.value(QZSettings::tile_elevation_enabled, QZSettings::default_tile_elevation_enabled /* true */).toBool() &&
                settings.value(QZSettings::tile_elevation_order, QZSettings::default_tile_elevation_order /* 0 */).toInt() == i) {
                elevation->setGridId(i);
                dataList.append(elevation);
            }

            if (settings.value(QZSettings::tile_elapsed_enabled, QZSettings::default_tile_elapsed_enabled /* true */).toBool() &&
                settings.value(QZSettings::tile_elapsed_order, QZSettings::default_tile_elapsed_order /* 0 */).toInt() == i) {
                elapsed->setGridId(i);
                dataList.append(elapsed);
            }

            if (settings.value(QZSettings::tile_moving_time_enabled, QZSettings::default_tile_moving_time_enabled /* false */).toBool() &&
                settings.value(QZSettings::tile_moving_time_order, QZSettings::default_tile_moving_time_order /* 19 */).toInt() == i) {
                moving_time->setGridId(i);
                dataList.append(moving_time);
            }

            if (settings.value(QZSettings::tile_peloton_offset_enabled, QZSettings::default_tile_peloton_offset_enabled /* false */).toBool() &&
                settings.value(QZSettings::tile_peloton_offset_order, QZSettings::default_tile_peloton_offset_order /* 20 */).toInt() == i) {
                peloton_offset->setGridId(i);
                dataList.append(peloton_offset);
            }

            if (settings.value(QZSettings::tile_peloton_remaining_enabled, QZSettings::default_tile_peloton_remaining_enabled /* false */).toBool() &&
                settings.value(QZSettings::tile_peloton_remaining_order, QZSettings::default_tile_peloton_remaining_order /* 20 */).toInt() == i) {
                peloton_remaining->setGridId(i);
                dataList.append(peloton_remaining);
            }

            if (settings.value(QZSettings::tile_calories_enabled, QZSettings::default_tile_calories_enabled /* true */).toBool() &&
                settings.value(QZSettings::tile_calories_order, QZSettings::default_tile_calories_order /* 0 */).toInt() == i) {
                calories->setGridId(i);
                dataList.append(calories);
            }

            if (settings.value(QZSettings::tile_odometer_enabled, QZSettings::default_tile_odometer_enabled /* true */).toBool() &&
                settings.value(QZSettings::tile_odometer_order, QZSettings::default_tile_odometer_order /* 0 */).toInt() == i) {
                odometer->setGridId(i);
                dataList.append(odometer);
            }

            if (settings.value(QZSettings::tile_pace_enabled, QZSettings::default_tile_pace_enabled /* true */).toBool() &&
                settings.value(QZSettings::tile_pace_order, QZSettings::default_tile_pace_order /* 0 */).toInt() == i) {
                pace->setGridId(i);
                dataList.append(pace);
            }

            if (settings.value(QZSettings::tile_watt_enabled, QZSettings::default_tile_watt_enabled /* true */).toBool() &&
                settings.value(QZSettings::tile_watt_order, QZSettings::default_tile_watt_order /* 0 */).toInt() == i) {
                watt->setGridId(i);
                dataList.append(watt);
            }

            if (settings.value(QZSettings::tile_weight_loss_enabled, QZSettings::default_tile_weight_loss_enabled /* false */).toBool() &&
                settings.value(QZSettings::tile_weight_loss_order, QZSettings::default_tile_weight_loss_order /* 24 */).toInt() == i) {
                weightLoss->setGridId(i);
                dataList.append(weightLoss);
            }

            if (settings.value(QZSettings::tile_avgwatt_enabled, QZSettings::default_tile_avgwatt_enabled /* true */).toBool() &&
                settings.value(QZSettings::tile_avgwatt_order, QZSettings::default_tile_avgwatt_order /* 0 */).toInt() == i) {
                avgWatt->setGridId(i);
                dataList.append(avgWatt);
            }

            if (settings.value(QZSettings::tile_ftp_enabled, QZSettings::default_tile_ftp_enabled /* true */).toBool() &&
                settings.value(QZSettings::tile_ftp_order, QZSettings::default_tile_ftp_order /* 0 */).toInt() == i) {
                ftp->setGridId(i);
                dataList.append(ftp);
            }

            if (settings.value(QZSettings::tile_jouls_enabled, QZSettings::default_tile_jouls_enabled /* true */).toBool() &&
                settings.value(QZSettings::tile_jouls_order, QZSettings::default_tile_jouls_order /* 0 */).toInt() == i) {
                jouls->setGridId(i);
                dataList.append(jouls);
            }

            if (settings.value(QZSettings::tile_heart_enabled, QZSettings::default_tile_heart_enabled /* true */).toBool() &&
                settings.value(QZSettings::tile_heart_order, QZSettings::default_tile_heart_order /* 0 */).toInt() == i) {
                heart->setGridId(i);
                dataList.append(heart);
            }

            if (settings.value(QZSettings::tile_fan_enabled, QZSettings::default_tile_fan_enabled /* true */).toBool() &&
                settings.value(QZSettings::tile_fan_order, QZSettings::default_tile_fan_order /* 0 */).toInt() == i) {
                fan->setGridId(i);
                dataList.append(fan);
            }

            if (settings.value(QZSettings::tile_datetime_enabled, QZSettings::default_tile_datetime_enabled /* true */).toBool() &&
                settings.value(QZSettings::tile_datetime_order, QZSettings::default_tile_datetime_order /* 0 */).toInt() == i) {
                datetime->setGridId(i);
                dataList.append(datetime);
            }

            if (settings.value(QZSettings::tile_lapelapsed_enabled, QZSettings::default_tile_lapelapsed_enabled /* false */).toBool() &&
                settings.value(QZSettings::tile_lapelapsed_order, QZSettings::default_tile_lapelapsed_order /* 18 */).toInt() == i) {
                lapElapsed->setGridId(i);
                dataList.append(lapElapsed);
            }

            if (settings.value(QZSettings::tile_watt_kg_enabled, QZSettings::default_tile_watt_kg_enabled /* false */).toBool() &&
                settings.value(QZSettings::tile_watt_kg_order, QZSettings::default_tile_watt_kg_order /* 24 */).toInt() == i) {
                wattKg->setGridId(i);
                dataList.append(wattKg);
            }

            if (settings.value(QZSettings::tile_remainingtimetrainprogramrow_enabled, QZSettings::default_tile_remainingtimetrainprogramrow_enabled /* false */).toBool() &&
                settings.value(QZSettings::tile_remainingtimetrainprogramrow_order, QZSettings::default_tile_remainingtimetrainprogramrow_order /* 27 */).toInt() == i) {
            ...
            if (settings.value(QZSettings::tile_mets_enabled, QZSettings::default_tile_mets_enabled /* false */).toBool() &&
                settings.value(QZSettings::tile_mets_order, QZSettings::default_tile_mets_order /* 28 */).toInt() == i) {

                mets->setGridId(i);
                dataList.append(mets);
            }
            if (settings.value(QZSettings::tile_targetmets_enabled, QZSettings::default_tile_targetmets_enabled /* false */).toBool() &&
                settings.value(QZSettings::tile_targetmets_order, QZSettings::default_tile_targetmets_order /* 29 */).toInt() == i) {

                targetMets->setGridId(i);
                dataList.append(targetMets);
            }

            if (settings.value(QZSettings::tile_target_speed_enabled, QZSettings::default_tile_target_speed_enabled /* false */).toBool() &&
                settings.value(QZSettings::tile_target_speed_order, QZSettings::default_tile_target_speed_order /* 28 */).toInt() == i) {
                target_speed->setGridId(i);
                dataList.append(target_speed);
            }

            if (settings.value(QZSettings::tile_target_incline_enabled, QZSettings::default_tile_target_incline_enabled /* false */).toBool() &&
                settings.value(QZSettings::tile_target_incline_order, QZSettings::default_tile_target_incline_order /* 29 */).toInt() == i) {
                target_incline->setGridId(i);
                dataList.append(target_incline);
            }

            if (settings.value(QZSettings::tile_cadence_enabled, QZSettings::default_tile_cadence_enabled /* false */).toBool() &&
                settings.value(QZSettings::tile_cadence_order, QZSettings::default_tile_cadence_order /* 30 */).toInt() == i) {
                cadence->setGridId(i);
                dataList.append(cadence);
            }

            if (settings.value(QZSettings::tile_pid_hr_enabled, QZSettings::default_tile_pid_hr_enabled /* false */).toBool() &&
                settings.value(QZSettings::tile_pid_hr_order, QZSettings::default_tile_pid_hr_order /* 31 */).toInt() == i) {
                pidHR->setGridId(i);
                dataList.append(pidHR);
            }

            if (settings.value(QZSettings::tile_instantaneous_stride_length_enabled, QZSettings::default_tile_instantaneous_stride_length_enabled /* false */).toBool() &&
                settings.value(QZSettings::tile_instantaneous_stride_length_order, QZSettings::default_tile_instantaneous_stride_length_order /* 32 */).toInt() == i) {
                instantaneousStrideLengthCM->setGridId(i);
                dataList.append(instantaneousStrideLengthCM);
            }

            if (settings.value(QZSettings::tile_ground_contact_enabled, QZSettings::default_tile_ground_contact_enabled /* false */).toBool() &&
                settings.value(QZSettings::tile_ground_contact_order, QZSettings::default_tile_ground_contact_order /* 33 */).toInt() == i) {
                groundContactMS->setGridId(i);
                dataList.append(groundContactMS);
            }

            if (settings.value(QZSettings::tile_vertical_oscillation_enabled, QZSettings::default_tile_vertical_oscillation_enabled /* false */).toBool() &&
                settings.value(QZSettings::tile_vertical_oscillation_order, QZSettings::default_tile_vertical_oscillation_order /* 34 */).toInt() == i) {
        ...
        for (int i = 0; i < 100; i++) {
            ...
            if (settings.value(QZSettings::tile_cadence_enabled, QZSettings::default_tile_cadence_enabled /* true */).toBool() &&
                settings.value(QZSettings::tile_cadence_order, QZSettings::default_tile_cadence_order /* 0 */).toInt() == i) {
                cadence->setGridId(i);
                dataList.append(cadence);
            }
            ...
            if (settings.value(QZSettings::tile_resistance_enabled, QZSettings::default_tile_resistance_enabled /* true */).toBool() &&
                settings.value(QZSettings::tile_resistance_order, QZSettings::default_tile_resistance_order /* 0 */).toInt() == i) {
                resistance->setGridId(i);
                dataList.append(resistance);
            }

            if (settings.value(QZSettings::tile_peloton_resistance_enabled, QZSettings::default_tile_peloton_resistance_enabled /* true */).toBool() &&
                settings.value(QZSettings::tile_peloton_resistance_order, QZSettings::default_tile_peloton_resistance_order /* 0 */).toInt() == i) {
            ...
            if (settings.value(QZSettings::tile_target_resistance_enabled, QZSettings::default_tile_target_resistance_enabled /* true */).toBool() &&
                settings.value(QZSettings::tile_target_resistance_order, QZSettings::default_tile_target_resistance_order /* 0 */).toInt() == i) {
                target_resistance->setGridId(i);
                dataList.append(target_resistance);
            }

            if (settings.value(QZSettings::tile_target_peloton_resistance_enabled, QZSettings::default_tile_target_peloton_resistance_enabled /* false */).toBool() &&
                settings.value(QZSettings::tile_target_peloton_resistance_order, QZSettings::default_tile_target_peloton_resistance_order /* 21 */).toInt() == i) {
                target_peloton_resistance->setGridId(i);
                dataList.append(target_peloton_resistance);
            }

            if (settings.value(QZSettings::tile_target_cadence_enabled, QZSettings::default_tile_target_cadence_enabled /* false */).toBool() &&
                settings.value(QZSettings::tile_target_cadence_order, QZSettings::default_tile_target_cadence_order /* 19 */).toInt() == i) {
                target_cadence->setGridId(i);
                dataList.append(target_cadence);
            }

            if (settings.value(QZSettings::tile_target_power_enabled, QZSettings::default_tile_target_power_enabled /* false */).toBool() &&
                settings.value(QZSettings::tile_target_power_order, QZSettings::default_tile_target_power_order /* 20 */).toInt() == i) {
                target_power->setGridId(i);
                dataList.append(target_power);
            }

            if (settings.value(QZSettings::tile_target_zone_enabled, QZSettings::default_tile_target_zone_enabled /* false */).toBool() &&
                settings.value(QZSettings::tile_target_zone_order, QZSettings::default_tile_target_zone_order /* 24 */).toInt() == i) {
            ...
            if (settings.value(QZSettings::tile_gears_enabled, QZSettings::default_tile_gears_enabled /* false */).toBool() &&
                settings.value(QZSettings::tile_gears_order, QZSettings::default_tile_gears_order /* 25 */).toInt() == i) {
                gears->setGridId(i);
            ...
            if (!pelotoncadence) {
                if (settings.value(QZSettings::tile_inclination_enabled, QZSettings::default_tile_inclination_enabled /* true */).toBool() &&
                    settings.value(QZSettings::tile_inclination_order, QZSettings::default_tile_inclination_order /* 29 */).toInt() == i) {
                    inclination->setGridId(i);
                    dataList.append(inclination);
                }
            }
            if (settings.value(QZSettings::tile_steering_angle_enabled, QZSettings::default_tile_steering_angle_enabled /* false */).toBool() &&
                settings.value(QZSettings::tile_steering_angle_order, QZSettings::default_tile_steering_angle_order /* 30 */).toInt() == i) {
            ...
            if (settings.value(QZSettings::tile_ext_incline_enabled, QZSettings::default_tile_ext_incline_enabled /* false */).toBool() &&
                settings.value(QZSettings::tile_ext_incline_order, QZSettings::default_tile_ext_incline_order /* 32 */).toInt() == i) {
        ...
        for (int i = 0; i < 100; i++) {
            ...
            if (settings.value(QZSettings::tile_strokes_length_enabled, QZSettings::default_tile_strokes_length_enabled /* false */).toBool() &&
                settings.value(QZSettings::tile_strokes_length_order, QZSettings::default_tile_strokes_length_order /* 21 */).toInt() == i) {
                strokesLength->setGridId(i);
                dataList.append(strokesLength);
            }

            if (settings.value(QZSettings::tile_strokes_count_enabled, QZSettings::default_tile_strokes_count_enabled /* false */).toBool() &&
                settings.value(QZSettings::tile_strokes_count_order, QZSettings::default_tile_strokes_count_order /* 22 */).toInt() == i) {
...
void homeform::deviceConnected(QBluetoothDeviceInfo b) {
    ...
    if (settings.value(QZSettings::pause_on_start, QZSettings::default_pause_on_start /* false */).toBool() &&
        bluetoothManager->device()->deviceType() != bluetoothdevice::TREADMILL) {
        Start();
    } else if (settings.value(QZSettings::pause_on_start_treadmill, QZSettings::default_pause_on_start_treadmill /* false */).toBool() &&
               bluetoothManager->device()->deviceType() == bluetoothdevice::TREADMILL) {
...
void homeform::Plus(const QString &name) {
    ...
    if (name.contains(QStringLiteral("speed"))) {
        if (bluetoothManager->device() && bluetoothManager->device()->deviceType() == bluetoothdevice::TREADMILL) {
            ...
            double step = settings.value(QZSettings::treadmill_step_speed, QZSettings::default_treadmill_step_speed /* 0.5 */).toDouble();
            if (!miles)
        ...
        if (bluetoothManager->device()) {
            if (bluetoothManager->device()->deviceType() == bluetoothdevice::TREADMILL) {
                double step = settings.value(QZSettings::treadmill_step_incline, QZSettings::default_treadmill_step_incline /* 0.5 */).toDouble();
        ...
        if (bluetoothManager->device()) {
            QSettings settings;
            QString zoneS =
                settings.value(QZSettings::treadmill_pid_heart_zone, QZSettings::default_treadmill_pid_heart_zone /* QStringLiteral("Disabled") */).toString();
            uint8_t zone = settings.value(QZSettings::treadmill_pid_heart_zone, QZSettings::default_treadmill_pid_heart_zone /* QStringLiteral("Disabled") */)
                               .toString()
                               .toUInt();
        ...
        QSettings settings;
        if (bluetoothManager->device()) {
            if (settings.value(QZSettings::fitmetria_fanfit_enable, QZSettings::default_fitmetria_fanfit_enable /* false */).toBool() &&
                settings.value(QZSettings::fitmetria_fanfit_mode, QZSettings::default_fitmetria_fanfit_mode /* QStringLiteral("Heart") */)
                    .toString()
                    .compare(QStringLiteral("Manual"))) {
                fanOverride += 10;
            } else if (settings.value(QZSettings::fitmetria_fanfit_enable, QZSettings::default_fitmetria_fanfit_enable /* false */).toBool()) {
...
void homeform::Start_inner(bool send_event_to_device) {
    ...
    if (settings.value(QZSettings::tts_enabled, QZSettings::default_tts_enabled /* false */).toBool())
...
void homeform::update() {
    ...
    if ((paused || stopped) && settings.value(QZSettings::top_bar_enabled, QZSettings::default_top_bar_enabled /* true */).toBool()) {
    ...
    if (bluetoothManager->device()) {
        ...
        bool power5s = settings.value(QZSettings::power_avg_5s, QZSettings::default_power_avg_5s /* false */).toBool();
        uint8_t treadmill_pid_heart_zone =
            settings.value(QZSettings::treadmill_pid_heart_zone, QZSettings::default_treadmill_pid_heart_zone /* QStringLiteral("Disabled") */).toString().toUInt();
        ...
        if (bluetoothManager->device()->deviceType() == bluetoothdevice::TREADMILL) {
            ...
            this->target_resistance->setSecondLine(
                ...
                QString::number(bluetoothManager->device()->difficult() *
                                    settings.value(QZSettings::bike_resistance_gain_f, QZSettings::default_bike_resistance_gain_f /* 1.0 */).toDouble() *
                                    settings.value(QZSettings::bike_resistance_offset, QZSettings::default_bike_resistance_offset /* 4.0 */).toDouble(),
                                'f', 0));
        ...
        if (trainProgram) {
            ...
            if (settings.value(QZSettings::tile_peloton_resistance_color_enabled, QZSettings::default_tile_peloton_resistance_color_enabled /* false */).toBool()) {
                if (lower_requested_peloton_resistance == -1) {
            ...
            if (settings.value(QZSettings::tile_cadence_color_enabled, QZSettings::default_tile_cadence_color_enabled /* false */).toBool()) {
                if (lower_cadence == -1) {
        ...
        if (percHeartRate < settings.value(QZSettings::heart_rate_zone1, QZSettings::default_heart_rate_zone1 /* 70.0 */).toDouble()) {
            currentHRZone = 1;
            currentHRZone += (percHeartRate / settings.value(QZSettings::heart_rate_zone1, QZSettings::default_heart_rate_zone1 /* 70.0 */).toDouble());
        ...
        } else if (percHeartRate < settings.value(QZSettings::heart_rate_zone2, QZSettings::default_heart_rate_zone2 /* 80.0 */).toDouble()) {
            currentHRZone = 2;
            currentHRZone += ((percHeartRate - settings.value(QZSettings::heart_rate_zone1, QZSettings::default_heart_rate_zone1 /* 70.0 */).toDouble()) /
                              (settings.value(QZSettings::heart_rate_zone2, QZSettings::default_heart_rate_zone2 /* 80.0 */).toDouble() -
                               settings.value(QZSettings::heart_rate_zone1, QZSettings::default_heart_rate_zone1 /* 70.0 */).toDouble()));
        ...
        } else if (percHeartRate < settings.value(QZSettings::heart_rate_zone3, QZSettings::default_heart_rate_zone3 /* 90.0 */).toDouble()) {
            currentHRZone = 3;
            currentHRZone += ((percHeartRate - settings.value(QZSettings::heart_rate_zone2, QZSettings::default_heart_rate_zone2 /* 80.0 */).toDouble()) /
                              (settings.value(QZSettings::heart_rate_zone3, QZSettings::default_heart_rate_zone3 /* 90.0 */).toDouble() -
                               settings.value(QZSettings::heart_rate_zone2, QZSettings::default_heart_rate_zone2 /* 80.0 */).toDouble()));
        ...
        } else if (percHeartRate < settings.value(QZSettings::heart_rate_zone4, QZSettings::default_heart_rate_zone4 /* 100.0 */).toDouble()) {
            currentHRZone = 4;
            currentHRZone += ((percHeartRate - settings.value(QZSettings::heart_rate_zone3, QZSettings::default_heart_rate_zone3 /* 90.0 */).toDouble()) /
                              (settings.value(QZSettings::heart_rate_zone4, QZSettings::default_heart_rate_zone4 /* 100.0 */).toDouble() -
                               settings.value(QZSettings::heart_rate_zone3, QZSettings::default_heart_rate_zone3 /* 90.0 */).toDouble()));
        ...
        */
...
#ifdef Q_OS_ANDROID
        if (settings.value(QZSettings::ant_cadence, QZSettings::default_ant_cadence /* false */).toBool() && KeepAwakeHelper::antObject(false)) {
        ...
        if (settings.value(QZSettings::trainprogram_random, QZSettings::default_trainprogram_random /* false */).toBool()) {
            if (!paused && !stopped) {
                ...
                if ((seconds / 60) < settings.value(QZSettings::trainprogram_total, QZSettings::default_trainprogram_total /* 60 */).toUInt()) {
                    qDebug() << QStringLiteral("trainprogram random seconds ") + QString::number(seconds) +
                                    ...
                                    settings.value(QZSettings::trainprogram_period_seconds, QZSettings::default_trainprogram_period_seconds /* 60 */).toUInt();
                    if (last_seconds == 0 ||
                        ...
                        if (bluetoothManager->device()->deviceType() == bluetoothdevice::TREADMILL &&
                            ...
                            double speed = settings.value(QZSettings::trainprogram_speed_min, QZSettings::default_trainprogram_speed_min /* 8 */).toUInt();
                            double incline = settings.value(QZSettings::trainprogram_incline_min, QZSettings::default_trainprogram_incline_min /* 0 */).toUInt();
                            if (!speed) {
                                speed = 1.0;
                            }
                            if (settings.value(QZSettings::trainprogram_speed_min, QZSettings::default_trainprogram_speed_min /* 8 */).toUInt() != 0 &&
                                settings.value(QZSettings::trainprogram_speed_min, QZSettings::default_trainprogram_speed_min /* 8 */).toUInt() <
                                    settings.value(QZSettings::trainprogram_speed_max, QZSettings::default_trainprogram_speed_max /* 16 */).toUInt()) {
                                speed =
                                    (double)r.bounded(
                                        settings.value(QZSettings::trainprogram_speed_min, QZSettings::default_trainprogram_speed_min /* 8 */).toUInt() * 10,
                                        settings.value(QZSettings::trainprogram_speed_max, QZSettings::default_trainprogram_speed_max /* 16 */).toUInt() * 10) /
                                    10.0;
                            }
                            if (settings.value(QZSettings::trainprogram_incline_min, QZSettings::default_trainprogram_incline_min /* 0 */).toUInt() <
                                settings.value(QZSettings::trainprogram_incline_max, QZSettings::default_trainprogram_incline_max /* 15 */).toUInt()) {
                                incline =
                                    (double)r.bounded(
                                        settings.value(QZSettings::trainprogram_incline_min, QZSettings::default_trainprogram_incline_min /* 0 */).toUInt() * 10,
                                        settings.value(QZSettings::trainprogram_incline_max, QZSettings::default_trainprogram_incline_max /* 15 */).toUInt() * 10) /
                                    10.0;
                            }
                            ...
                            double resistance =
                                settings.value(QZSettings::trainprogram_resistance_min, QZSettings::default_trainprogram_resistance_min /* 1 */).toUInt();
                            if (settings.value(QZSettings::trainprogram_resistance_min, QZSettings::default_trainprogram_resistance_min /* 1 */).toUInt() <
                                settings.value(QZSettings::trainprogram_resistance_max, QZSettings::default_trainprogram_resistance_max /* 32 */).toUInt()) {
        ...
        } else if (!settings.value(QZSettings::treadmill_pid_heart_zone, QZSettings::default_treadmill_pid_heart_zone /* QStringLiteral("Disabled") */)
                        .toString()
            ...
            if (last_seconds_pid_heart_zone == 0 || ((seconds - last_seconds_pid_heart_zone) >= delta)) {
                ...
                double zone = settings.value(QZSettings::treadmill_pid_heart_zone, QZSettings::default_treadmill_pid_heart_zone /* QStringLiteral("Disabled") */)
                                   .toString()
                                   .toUInt();
                if (fromTrainProgram) {
        ...
        if (settings.value(QZSettings::fitmetria_fanfit_enable, QZSettings::default_fitmetria_fanfit_enable /* false */).toBool()) {
            if (!settings.value(QZSettings::fitmetria_fanfit_mode, QZSettings::default_fitmetria_fanfit_mode /* QStringLiteral("Heart") */)
                     .toString()
                     .compare(QStringLiteral("Manual"))) {
            ...
            // Heart Mode
            else if (!settings.value(QZSettings::fitmetria_fanfit_mode, QZSettings::default_fitmetria_fanfit_mode /* QStringLiteral("Heart") */)
                          .toString()
        ...
        if (!stopped && !paused) {
            if (settings.value(QZSettings::tts_enabled, QZSettings::default_tts_enabled /* false */).toBool()) {
                if (++tts_summary_count >= settings.value(QZSettings::tts_summary_sec, QZSettings::default_tts_summary_sec /* 120 */).toInt() &&
                    m_speech.state() == QTextToSpeech::Ready) {
                    tts_summary_count = 0;

                    QString s;
                    if (settings.value(QZSettings::tts_act_speed, QZSettings::default_tts_act_speed /* false */).toBool())
                        s.append(tr(", speed ") +
                                 (!miles ? QString::number(bluetoothManager->device()->currentSpeed().value(), 'f', 1) +
                                         ...
                                         : QString::number(bluetoothManager->device()->currentSpeed().value() *
                                                           ...
                                                           'f', 1)) +
                                 tr(" miles per hour"));
                    if (settings.value(QZSettings::tts_avg_speed, QZSettings::default_tts_avg_speed /* true */).toBool())
                        s.append(tr(", Average speed ") +
                                 (!miles
                                      ...
                                      : QString::number(bluetoothManager->device()->currentSpeed().average() *
                                                        ...
                                                        'f', 1)) +
                                 tr(" miles per hour"));
                    if (settings.value(QZSettings::tts_max_speed, QZSettings::default_tts_max_speed /* false */).toBool())
                        s.append(
                            tr(", Max speed ") +
                            ...
                            tr(" miles per hour"));
                    if (settings.value(QZSettings::tts_act_inclination, QZSettings::default_tts_act_inclination /* false */).toBool())
                        s.append(tr(", inclination ") +
                                 QString::number(bluetoothManager->device()->currentInclination().value(), 'f', 1));
                    if (settings.value(QZSettings::tts_act_cadence, QZSettings::default_tts_act_cadence /* false */).toBool())
                        s.append(tr(", cadence ") +
                                 QString::number(bluetoothManager->device()->currentCadence().value(), 'f', 0));
                    if (settings.value(QZSettings::tts_avg_cadence, QZSettings::default_tts_avg_cadence /* true */).toBool())
                        s.append(tr(", Average cadence ") +
                                 QString::number(bluetoothManager->device()->currentCadence().average(), 'f', 0));
                    if (settings.value(QZSettings::tts_max_cadence, QZSettings::default_tts_max_cadence /* true */).toBool())
                        s.append(tr(", Max cadence ") +
                                 QString::number(bluetoothManager->device()->currentCadence().max()));
                    if (settings.value(QZSettings::tts_act_elevation, QZSettings::default_tts_act_elevation /* true */).toBool())
                        s.append(tr(", elevation ") +
                                 (!miles
                                      ...
                                      : QString::number(bluetoothManager->device()->elevationGain().value() *
                                                        ...
                                                        'f', 1)) +
                                 tr(" feet"));
                    if (settings.value(QZSettings::tts_act_calories, QZSettings::default_tts_act_calories /* true */).toBool())
                        s.append(tr(", calories burned ") +
                                 QString::number(bluetoothManager->device()->calories().value(), 'f', 0));
                    if (settings.value(QZSettings::tts_act_odometer, QZSettings::default_tts_act_odometer /* true */).toBool())
                        s.append(
                            tr(", distance ") +
                            (!miles
                            ...
                            tr(" miles"));
                    if (settings.value(QZSettings::tts_act_pace, QZSettings::default_tts_act_pace /* false */).toBool())
                        s.append(tr(", pace ") +
                                 bluetoothManager->device()->currentPace().toString(QStringLiteral("m:ss")));
                    if (settings.value(QZSettings::tts_avg_pace, QZSettings::default_tts_avg_pace /* true */).toBool())
                        s.append(tr(", pace ") +
                                 bluetoothManager->device()->averagePace().toString(QStringLiteral("m:ss")));
                    if (settings.value(QZSettings::tts_max_pace, QZSettings::default_tts_max_pace /* false */).toBool())
                        s.append(tr(", pace ") +
                                 bluetoothManager->device()->maxPace().toString(QStringLiteral("m:ss")));
                    if (settings.value(QZSettings::tts_act_resistance, QZSettings::default_tts_act_resistance /* true */).toBool())
                        s.append(tr(", resistance ") +
                                 QString::number(bluetoothManager->device()->currentResistance().value(), 'f', 0));
                    if (settings.value(QZSettings::tts_avg_resistance, QZSettings::default_tts_avg_resistance /* true */).toBool())
                        s.append(tr(", average resistance ") +
                                 QString::number(bluetoothManager->device()->currentResistance().average(), 'f', 0));
                    if (settings.value(QZSettings::tts_max_resistance, QZSettings::default_tts_max_resistance /* false */).toBool())
                        s.append(tr(", max resistance ") +
                                 QString::number(bluetoothManager->device()->currentResistance().max(), 'f', 0));
                    if (settings.value(QZSettings::tts_act_watt, QZSettings::default_tts_act_watt /* false */).toBool())
                        s.append(tr(", watt ") +
                                 QString::number(bluetoothManager->device()->wattsMetric().value(), 'f', 0));
                    if (settings.value(QZSettings::tts_avg_watt, QZSettings::default_tts_avg_watt /* true */).toBool())
                        s.append(tr(", average watt ") +
                                 QString::number(bluetoothManager->device()->wattsMetric().average(), 'f', 0));
                    if (settings.value(QZSettings::tts_max_watt, QZSettings::default_tts_max_watt /* true */).toBool())
                    ...
                    if (settings.value(QZSettings::tts_act_heart, QZSettings::default_tts_act_heart /* true */).toBool())
                        s.append(tr(", heart rate ") +
                                 QString::number(bluetoothManager->device()->currentHeart().value(), 'f', 0));
                    if (settings.value(QZSettings::tts_avg_heart, QZSettings::default_tts_avg_heart /* true */).toBool())
                        s.append(tr(", average heart rate ") +
                                 QString::number(bluetoothManager->device()->currentHeart().average(), 'f', 0));
                    if (settings.value(QZSettings::tts_max_heart, QZSettings::default_tts_max_heart /* false */).toBool())
                        s.append(tr(", max heart rate ") +
                                 QString::number(bluetoothManager->device()->currentHeart().max(), 'f', 0));
                    if (settings.value(QZSettings::tts_act_jouls, QZSettings::default_tts_act_jouls /* true */).toBool())
                        s.append(tr(", jouls ") + QString::number(bluetoothManager->device()->jouls().max(), 'f', 0));
                    if (settings.value(QZSettings::tts_act_elapsed, QZSettings::default_tts_act_elapsed /* true */).toBool())
                        s.append(tr(", elapsed ") +
                    ...
                    if (settings.value(QZSettings::tts_act_peloton_resistance, QZSettings::default_tts_act_peloton_resistance /* false */).toBool() &&
                    ...
                    if (settings.value(QZSettings::tts_avg_peloton_resistance, QZSettings::default_tts_avg_peloton_resistance /* false */).toBool() &&
                        bluetoothManager->device()->deviceType() == bluetoothdevice::BIKE)
                        s.append(tr(", average peloton resistance ") +
                                 QString::number(((bike *)bluetoothManager->device())->pelotonResistance().average(),
                                                 'f', 0));
                    if (settings.value(QZSettings::tts_max_peloton_resistance, QZSettings::default_tts_max_peloton_resistance /* false */).toBool() &&
                        bluetoothManager->device()->deviceType() == bluetoothdevice::BIKE)
                        s.append(
                            tr(", max peloton resistance ") +
                            QString::number(((bike *)bluetoothManager->device())->pelotonResistance().max(), 'f', 0));
                    if (settings.value(QZSettings::tts_act_target_peloton_resistance, QZSettings::default_tts_act_target_peloton_resistance /* true */).toBool() &&
                        bluetoothManager->device()->deviceType() == bluetoothdevice::BIKE)
                        s.append(tr(", target peloton resistance ") +
                                 QString::number(
                                     ((bike *)bluetoothManager->device())->lastRequestedPelotonResistance().value(),
                                     'f', 0));
                    if (settings.value(QZSettings::tts_act_target_cadence, QZSettings::default_tts_act_target_cadence /* true */).toBool() &&
                        bluetoothManager->device()->deviceType() == bluetoothdevice::BIKE)
                        s.append(tr(", target cadence ") +
                                 QString::number(((bike *)bluetoothManager->device())->lastRequestedCadence().value(),
                                                 'f', 0));
                    if (settings.value(QZSettings::tts_act_target_power, QZSettings::default_tts_act_target_power /* true */).toBool() &&
                        bluetoothManager->device()->deviceType() == bluetoothdevice::BIKE)
                        s.append(tr(", target power ") +
                                 QString::number(((bike *)bluetoothManager->device())->lastRequestedPower().value(),
                                                 'f', 0));
                    if (settings.value(QZSettings::tts_act_target_zone, QZSettings::default_tts_act_target_zone /* true */).toBool() &&
                        bluetoothManager->device()->deviceType() == bluetoothdevice::BIKE)
                        s.append(tr(", target zone ") + QString::number(requestedZone, 'f', 1));
                    if (settings.value(QZSettings::tts_act_target_speed, QZSettings::default_tts_act_target_speed /* true */).toBool() &&
                        bluetoothManager->device()->deviceType() == bluetoothdevice::TREADMILL)
                        s.append(tr(", target speed ") +
                                 (!miles ? QString::number(
                                         ...
                                         : QString::number(
                                               ...
                                               'f', 1)) +
                                 tr(" miles per hour"));
                    if (settings.value(QZSettings::tts_act_target_incline, QZSettings::default_tts_act_target_incline /* true */).toBool() &&
                        bluetoothManager->device()->deviceType() == bluetoothdevice::TREADMILL)
                        s.append(
                            tr(", target incline ") +
                            QString::number(
                                ((treadmill *)bluetoothManager->device())->lastRequestedInclination().value(), 'f', 1));
                    if (settings.value(QZSettings::tts_act_watt_kg, QZSettings::default_tts_act_watt_kg /* false */).toBool())
                        s.append(tr(", watt for kilograms ") +
                                 QString::number(bluetoothManager->device()->wattKg().value(), 'f', 1));
                    if (settings.value(QZSettings::tts_avg_watt_kg, QZSettings::default_tts_avg_watt_kg /* false */).toBool())
                        s.append(tr(", average watt for kilograms") +
                                 QString::number(bluetoothManager->device()->wattKg().average(), 'f', 1));
                    if (settings.value(QZSettings::tts_max_watt_kg, QZSettings::default_tts_max_watt_kg /* false */).toBool())
...
bool homeform::strava_upload_file(const QByteArray &data, const QString &remotename) {
    ...
    QString activityName =
        QStringLiteral(" ") + settings.value(QZSettings::strava_suffix, QZSettings::default_strava_suffix /* QStringLiteral("#QZ") */).toString();
    if (!stravaPelotonActivityName.isEmpty()) {
        ...
        if (pelotonHandler && settings.value(QZSettings::peloton_description_link, QZSettings::default_peloton_description_link /* true */).toBool())
            activityDescription =
...
void homeform::sendMail() {
    ...
    if (settings.value(QZSettings::user_email, QZSettings::default_user_email /* "" */).toString().length() == 0 || !bluetoothManager->device()) {
        return;
    }
...
double homeform::heartRateMax() {
    QSettings settings;
    double maxHeartRate = 220.0 - settings.value(QZSettings::age, QZSettings::default_age /* 35 */).toDouble();

    if (settings.value(QZSettings::heart_max_override_enable, QZSettings::default_heart_max_override_enable /* false */).toBool())
        maxHeartRate = settings.value(QZSettings::heart_max_override_value, QZSettings::default_heart_max_override_value /* 195 */).toDouble();
    if (maxHeartRate == 0) {
        maxHeartRate = 190.0;
    }
    return maxHeartRate;
...
void homeform::changeTimestamp(QTime source, QTime actual) {
    ...
    QSettings settings;
    int filterSeconds = settings.value(QZSettings::video_playback_window_s, QZSettings::default_video_playback_window_s /* 12 */).toInt();
