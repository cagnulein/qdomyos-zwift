...
void serialDircon::run() {
    ...
    const uint8_t init4[] = {0x02, 0x68, 0x04, 0x00, 0x6c, 0x03};
    const uint8_t init5[] = {0x02, 0x68, 0x50, 0x0b, 0x11, 0x00, 0x00, 0x44, 0x00,
                             0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x66, 0x03};
    const uint8_t init6[] = {0x02, 0x68, 0x50, 0x13, 0x08, 0x00, 0x00, 0x34, 0x00, 0x00, 0x00, 0xb8, 0x6c,
                             0x15, 0x1f, 0x00, 0x00, 0xc7, 0x05, 0x81, 0x0a, 0xf0, 0xa3, 0xd3, 0x03};
    const uint8_t init7[] = {0x02, 0x68, 0x04, 0x00, 0x6c, 0x03};
    const uint8_t init8[] = {0x02, 0x68, 0x04, 0x00, 0x6c, 0x03, 0x00, 0x00, 0x00, 0x00, 0xf0, 0xfc, 0xc0};
