/****************************************************************************
** Meta object code from reading C++ file 'sportstechbike.h'
**
...
#error "The header file 'sportstechbike.h' doesn't include <QObject>."
...
struct qt_meta_stringdata_sportstechbike_t {
    QByteArrayData data[32];
    char stringdata0[501];
};
#define QT_MOC_LITERAL(idx, ofs, len) \
    Q_STATIC_BYTE_ARRAY_DATA_HEADER_INITIALIZER_WITH_OFFSET(len, \
    qptrdiff(offsetof(qt_meta_stringdata_sportstechbike_t, stringdata0) + ofs \
        - idx * sizeof(QByteArrayData)) \
    )
static const qt_meta_stringdata_sportstechbike_t qt_meta_stringdata_sportstechbike = {
    {
QT_MOC_LITERAL(0, 0, 14), // "sportstechbike"
...
QT_MOC_LITERAL(31, 469, 31) // "QLowEnergyService::ServiceError"
    ...
    "sportstechbike\0disconnected\0\0debug\0"
...
static const uint qt_meta_data_sportstechbike[] = {
...
void sportstechbike::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        auto *_t = static_cast<sportstechbike *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
        ...
        {
            using _t = void (sportstechbike::*)();
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&sportstechbike::disconnected)) {
                *result = 0;
                return;
            }
        }
        {
            using _t = void (sportstechbike::*)(QString );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&sportstechbike::debug)) {
                *result = 1;
                return;
            }
        }
        {
            using _t = void (sportstechbike::*)();
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&sportstechbike::packetReceived)) {
                *result = 2;
                return;
            }
        }
...
QT_INIT_METAOBJECT const QMetaObject sportstechbike::staticMetaObject = { {
    QMetaObject::SuperData::link<bike::staticMetaObject>(),
    qt_meta_stringdata_sportstechbike.data,
    qt_meta_data_sportstechbike,
    qt_static_metacall,
    nullptr,
    nullptr
} };
...
const QMetaObject *sportstechbike::metaObject() const
{
    return QObject::d_ptr->metaObject ? QObject::d_ptr->dynamicMetaObject() : &staticMetaObject;
}

void *sportstechbike::qt_metacast(const char *_clname)
{
    if (!_clname) return nullptr;
    if (!strcmp(_clname, qt_meta_stringdata_sportstechbike.stringdata0))
        return static_cast<void*>(this);
    return bike::qt_metacast(_clname);
}

int sportstechbike::qt_metacall(QMetaObject::Call _c, int _id, void **_a)
{
...
// SIGNAL 0
void sportstechbike::disconnected()
{
    QMetaObject::activate(this, &staticMetaObject, 0, nullptr);
}

// SIGNAL 1
void sportstechbike::debug(QString _t1)
{
...
// SIGNAL 2
void sportstechbike::packetReceived()
{
