...
void proformbike::btinit() {
    ...
    if (settings.value(QZSettings::proform_studio, QZSettings::default_proform_studio).toBool()) {
        ...
        uint8_t initData30[] = {0xff, 0x05, 0x00, 0x80, 0x00, 0x00, 0xa9, 0x00, 0x00, 0x00,
                            0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00};
        ...
        uint8_t initData33[] = {0xff, 0x05, 0x00, 0x80, 0x00, 0x00, 0xa9, 0x00, 0x00, 0x00,
                            0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00};
        ...
        uint8_t initData35[] = {0x00, 0x12, 0x02, 0x04, 0x02, 0x13, 0x08, 0x13, 0x02, 0x00,
                            0x0d, 0x01, 0x0e, 0x41, 0x00, 0x00, 0x40, 0x00, 0x00, 0x80};
        writeCharacteristic(initData35, sizeof(initData35), QStringLiteral("init"), false, false);
        QThread::msleep(400);

        uint8_t initData36[] = {0xff, 0x05, 0x10, 0x00, 0x00, 0x81, 0xcb, 0x00, 0x00, 0x00,
                            0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00};
        ...
        uint8_t initData38[] = {0x00, 0x12, 0x02, 0x04, 0x02, 0x13, 0x08, 0x13, 0x02, 0x00,
                            0x0d, 0x01, 0x0e, 0x41, 0x00, 0x00, 0x40, 0x00, 0x00, 0x80};
        writeCharacteristic(initData38, sizeof(initData38), QStringLiteral("init"), false, false);
        QThread::msleep(400);

        uint8_t initData39[] = {0xff, 0x05, 0x10, 0x00, 0x00, 0x81, 0xcb, 0x00, 0x00, 0x00,
                            0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00};
