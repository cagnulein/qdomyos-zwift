...
void proformbike::update() {
    ...
    if (initRequest) {
        ...
        uint8_t noOpData1_proform_bike_PFEVEX71316_0[] = {0xfe, 0x02, 0x19, 0x03};

        uint8_t noOpData2_proform_bike_PFEVEX71316_0[] = {0x00, 0x12, 0x02, 0x04, 0x02, 0x15, 0x08, 0x15, 0x02, 0x00,
                                                        0x0f, 0xb6, 0x10, 0x30, 0x04, 0x00, 0x00, 0x00, 0x00, 0x00};

        uint8_t noOpData3_proform_bike_PFEVEX71316_0[] = {0xff, 0x07, 0x00, 0x00, 0x00, 0x00, 0x00, 0x10, 0x38, 0x00,
                                                        0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00};
        ...
        uint8_t noOpData6_proform_bike_PFEVEX71316_0[] = {0xff, 0x05, 0x18, 0x00, 0x00, 0x81, 0xab, 0x00, 0x00, 0x00,
                                                        0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00};
...
void proformbike::characteristicChanged(const QLowEnergyCharacteristic &characteristic, const QByteArray &newValue) {
    ...
    if (proform_studio || proform_tdf_10 || proform_bike_PFEVEX71316_0) {
        if (newValue.length() != 20 ||
            ...
            (newValue.at(0) == 0x00 &&
             (newValue.at(2) != 0x01 || newValue.at(3) != 0x04 || newValue.at(4) != 0x02 || (proform_bike_PFEVEX71316_0 ? newValue.at(5) != 0x2f : newValue.at(5) != 0x2c))) ||
...
void proformbike::btinit() {
    ...
    if (settings.value(QZSettings::proform_studio, QZSettings::default_proform_studio).toBool()) {
        ...
        uint8_t initData12[] = {0xff, 0x08, 0xa0, 0x91, 0x40, 0x88, 0x02, 0x00, 0x00, 0x21, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00};
        ...
        uint8_t initData14[] = {0x00, 0x12, 0x02, 0x04, 0x02, 0x15, 0x08, 0x15, 0x02, 0x0e, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00};
        writeCharacteristic(initData14, sizeof(initData14), QStringLiteral("init"), false, false);
        QThread::msleep(400);

        uint8_t initData15[] = {0xff, 0x07, 0x00, 0x00, 0x00, 0x10, 0x01, 0x00, 0x3e, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00};
        writeCharacteristic(initData15, sizeof(initData15), QStringLiteral("init"), false, false);
        QThread::msleep(400);
        ...
        uint8_t initData19[] = {0xfe, 0x02, 0x19, 0x03};
        writeCharacteristic(initData19, sizeof(initData19), QStringLiteral("init"), false, false);
        QThread::msleep(400);

        uint8_t initData20[] = {0x00, 0x12, 0x02, 0x04, 0x02, 0x15, 0x08, 0x15, 0x02, 0x00, 0x0f, 0x00, 0x10, 0x00, 0xdc, 0x1c, 0x4c, 0x00, 0x00, 0xe0};
        writeCharacteristic(initData20, sizeof(initData20), QStringLiteral("init"), false, false);
        QThread::msleep(400);

        uint8_t initData21[] = {0xff, 0x07, 0x00, 0x00, 0x00, 0x10, 0x00, 0x08, 0x7a, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00};
        writeCharacteristic(initData21, sizeof(initData21), QStringLiteral("init"), false, false);
        QThread::msleep(400);

        uint8_t initData22[] = {0xfe, 0x02, 0x14, 0x03};
        writeCharacteristic(initData22, sizeof(initData22), QStringLiteral("init"), false, false);
        QThread::msleep(400);

        uint8_t initData23[] = {0x00, 0x12, 0x02, 0x04, 0x02, 0x10, 0x08, 0x10, 0x02, 0x00,
                            0x0a, 0x3e, 0x90, 0x30, 0x04, 0x00, 0x00, 0x50, 0x00, 0x00};
        writeCharacteristic(initData23, sizeof(initData23), QStringLiteral("init"), false, false);
        QThread::msleep(400);

        uint8_t initData24[] = {0xff, 0x02, 0x08, 0x7e, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
                            0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00};
        writeCharacteristic(initData24, sizeof(initData24), QStringLiteral("init"), false, false);
        QThread::msleep(400);

        uint8_t initData25[] = {0xfe, 0x02, 0x14, 0x03};
        writeCharacteristic(initData25, sizeof(initData25), QStringLiteral("init"), false, false);
        QThread::msleep(400);

        uint8_t initData26[] = {0x00, 0x12, 0x02, 0x04, 0x02, 0x10, 0x08, 0x10, 0x02, 0x00, 0x0a, 0x3e, 0x90, 0x30, 0x04, 0x00, 0x00, 0x50, 0x00, 0x00};
        writeCharacteristic(initData26, sizeof(initData26), QStringLiteral("init"), false, false);
        QThread::msleep(400);

        uint8_t initData27[] = {0xff, 0x02, 0x08, 0x7e, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00};
        writeCharacteristic(initData27, sizeof(initData27), QStringLiteral("init"), false, false);
        QThread::msleep(400);

        uint8_t initData28[] = {0xfe, 0x02, 0x17, 0x03};
        writeCharacteristic(initData28, sizeof(initData28), QStringLiteral("init"), false, false);
        QThread::msleep(400);

        uint8_t initData29[] = {0x00, 0x12, 0x02, 0x04, 0x02, 0x13, 0x08, 0x13, 0x02, 0x0c,
                            0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00};
        writeCharacteristic(initData29, sizeof(initData29), QStringLiteral("init"), false, false);
        QThread::msleep(400);

        uint8_t initData30[] = {0xff, 0x05, 0x00, 0x80, 0x01, 0x00, 0xaa, 0x00, 0x00, 0x00,
                            0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00};
        writeCharacteristic(initData30, sizeof(initData30), QStringLiteral("init"), false, false);
        QThread::msleep(400);

        uint8_t initData31[] = {0xfe, 0x02, 0x17, 0x03};
        writeCharacteristic(initData31, sizeof(initData31), QStringLiteral("init"), false, false);
        QThread::msleep(400);

        uint8_t initData32[] = {0x00, 0x12, 0x02, 0x04, 0x02, 0x13, 0x08, 0x13, 0x02, 0x0c,
                            0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00};
        writeCharacteristic(initData32, sizeof(initData32), QStringLiteral("init"), false, false);
        QThread::msleep(400);

        uint8_t initData33[] = {0xff, 0x05, 0x00, 0x80, 0x01, 0x00, 0xaa, 0x00, 0x00, 0x00,
                            0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00};
        writeCharacteristic(initData33, sizeof(initData33), QStringLiteral("init"), false, false);
        QThread::msleep(400);

        uint8_t initData34[] = {0xfe, 0x02, 0x17, 0x03};
        writeCharacteristic(initData34, sizeof(initData34), QStringLiteral("init"), false, false);
        QThread::msleep(400);

        uint8_t initData35[] = {0x00, 0x12, 0x02, 0x04, 0x02, 0x13, 0x08, 0x13, 0x02, 0x0c,
                            0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00};
        writeCharacteristic(initData35, sizeof(initData35), QStringLiteral("init"), false, false);
        QThread::msleep(400);

        uint8_t initData36[] = {0xff, 0x05, 0x00, 0x80, 0x00, 0x00, 0xa9, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00};
        writeCharacteristic(initData36, sizeof(initData36), QStringLiteral("init"), false, false);
        QThread::msleep(400);

        uint8_t initData37[] = {0xfe, 0x02, 0x17, 0x03};
        writeCharacteristic(initData37, sizeof(initData37), QStringLiteral("init"), false, false);
        QThread::msleep(400);

        uint8_t initData38[] = {0x00, 0x12, 0x02, 0x04, 0x02, 0x13, 0x08, 0x13, 0x02, 0x0c,
                            0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00};
        writeCharacteristic(initData38, sizeof(initData38), QStringLiteral("init"), false, false);
        QThread::msleep(400);

        uint8_t initData39[] = {0xff, 0x05, 0x00, 0x80, 0x00, 0x00, 0xa9, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00};
        writeCharacteristic(initData39, sizeof(initData39), QStringLiteral("init"), false, false);
        QThread::msleep(400);
        ...
        uint8_t initData40[] = {0xff, 0x05, 0x00, 0x80, 0x00, 0x00, 0xa9, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00};
        writeCharacteristic(initData40, sizeof(initData40), QStringLiteral("init"), false, false);
        QThread::msleep(400);
