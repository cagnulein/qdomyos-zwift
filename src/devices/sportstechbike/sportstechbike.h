#ifndef SPORTSTECHBIKE_H
#define SPORTSTECHBIKE_H
...
class sportstechbike : public bike {
    Q_OBJECT
  public:
    sportstechbike(bool noWriteResistance, bool noHeartService, uint8_t bikeResistanceOffset,
