...
void horizontreadmill::btinit() {
    ...
    for (int l = 0; l < horizon_treadmill_profile_users.length(); l++) {
        ...
        for (int i = 0; i < 9; i++) {
            ...
            switch (l) {
            case 0:
                profile.initData7_2[11 + i] = Char;
                break;
            case 1:
                profile.initData7_3[11 + i] = Char;
                break;
            case 2:
                profile.initData7_4[11 + i] = Char;
                break;
            case 3:
                profile.initData7_5[11 + i] = Char;
                break;
            default:
                profile.initData7_6[11 + i] = Char;
                break;
            }
        }
    }
    ...
    profile.initData10[2] = unit_byte2;
    profile.initData10[10] = unit_byte10;
    profile.initData10_1[2] = unit_byte2;
    profile.initData10_1[10] = unit_byte10;
    profile.initData10_2[2] = unit_byte2;
    profile.initData10_2[10] = unit_byte10;
    profile.initData10_3[2] = unit_byte2;
    profile.initData10_3[10] = unit_byte10;
    profile.initData10_4[2] = unit_byte2;
    profile.initData10_4[10] = unit_byte10;
    profile.initData10_5[2] = unit_byte2;
    profile.initData10_5[10] = unit_byte10;
    profile.initData10_6[2] = unit_byte2;
    profile.initData10_6[10] = unit_byte10;
    ...
    if (gattCustomService) {
        ...
        init1:
            ...
            writeCharacteristic(gattCustomService, gattWriteCharCustomService, profile.initData7, sizeof(profile.initData7),
                                QStringLiteral("init"), false, false);
            writeCharacteristic(gattCustomService, gattWriteCharCustomService, profile.initData8, sizeof(profile.initData8),
                                QStringLiteral("init"), false, false);
            writeCharacteristic(gattCustomService, gattWriteCharCustomService, profile.initData8, sizeof(profile.initData8),
                                QStringLiteral("init"), false, false);
            writeCharacteristic(gattCustomService, gattWriteCharCustomService, profile.initData9, sizeof(profile.initData9),
                                QStringLiteral("init"), false, false);
            writeCharacteristic(gattCustomService, gattWriteCharCustomService, profile.initData10, sizeof(profile.initData10),
                                QStringLiteral("init"), false, false);
            writeCharacteristic(gattCustomService, gattWriteCharCustomService, profile.initData11, sizeof(profile.initData11),
                                QStringLiteral("init"), false, false);
            writeCharacteristic(gattCustomService, gattWriteCharCustomService, profile.initData11, sizeof(profile.initData11),
                                QStringLiteral("init"), false, false);
            writeCharacteristic(gattCustomService, gattWriteCharCustomService, profile.initData11, sizeof(profile.initData11),
            ...
            writeCharacteristic(gattCustomService, gattWriteCharCustomService, profile.initData11, sizeof(profile.initData11),
                                QStringLiteral("init"), false, false);
            writeCharacteristic(gattCustomService, gattWriteCharCustomService, profile.initData12, sizeof(profile.initData12),
                                QStringLiteral("init"), false, false);
            writeCharacteristic(gattCustomService, gattWriteCharCustomService, profile.initData8, sizeof(profile.initData8),
                                QStringLiteral("init"), false, false);
            writeCharacteristic(gattCustomService, gattWriteCharCustomService, profile.initData8, sizeof(profile.initData8),
            ...
            writeCharacteristic(gattCustomService, gattWriteCharCustomService, profile.initData8, sizeof(profile.initData8),
                                QStringLiteral("init"), false, false);
            writeCharacteristic(gattCustomService, gattWriteCharCustomService, profile.initData13, sizeof(profile.initData13),
                                QStringLiteral("init"), false, false);
            writeCharacteristic(gattCustomService, gattWriteCharCustomService, profile.initData14, sizeof(profile.initData14),
                                QStringLiteral("init"), false, true);
        ...
        init2:
            ...
            writeCharacteristic(gattCustomService, gattWriteCharCustomService, profile.initData7_1, sizeof(profile.initData7_1),
                                QStringLiteral("init"), false, false);
            writeCharacteristic(gattCustomService, gattWriteCharCustomService, profile.initData8, sizeof(profile.initData8),
                                QStringLiteral("init"), false, false);
            writeCharacteristic(gattCustomService, gattWriteCharCustomService, profile.initData8, sizeof(profile.initData8),
                                QStringLiteral("init"), false, false);
            writeCharacteristic(gattCustomService, gattWriteCharCustomService, profile.initData9_1, sizeof(profile.initData9_1),
                                QStringLiteral("init"), false, false);
            writeCharacteristic(gattCustomService, gattWriteCharCustomService, profile.initData10_1, sizeof(profile.initData10_1),
                                QStringLiteral("init"), false, false);
            writeCharacteristic(gattCustomService, gattWriteCharCustomService, profile.initData11, sizeof(profile.initData11),
                                QStringLiteral("init"), false, false);
            writeCharacteristic(gattCustomService, gattWriteCharCustomService, profile.initData11, sizeof(profile.initData11),
        ...
        init3:
            ...
            writeCharacteristic(gattCustomService, gattWriteCharCustomService, profile.initData7_2, sizeof(profile.initData7_2),
                                QStringLiteral("init"), false, false);
            writeCharacteristic(gattCustomService, gattWriteCharCustomService, profile.initData8, sizeof(profile.initData8),
                                QStringLiteral("init"), false, false);
            writeCharacteristic(gattCustomService, gattWriteCharCustomService, profile.initData8, sizeof(profile.initData8),
                                QStringLiteral("init"), false, false);
            writeCharacteristic(gattCustomService, gattWriteCharCustomService, profile.initData9_2, sizeof(profile.initData9_2),
                                QStringLiteral("init"), false, false);
            writeCharacteristic(gattCustomService, gattWriteCharCustomService, profile.initData10_2, sizeof(profile.initData10_2),
                                QStringLiteral("init"), false, false);
            writeCharacteristic(gattCustomService, gattWriteCharCustomService, profile.initData11, sizeof(profile.initData11),
                                QStringLiteral("init"), false, false);
            writeCharacteristic(gattCustomService, gattWriteCharCustomService, profile.initData11, sizeof(profile.initData11),
        ...
        init4:
            ...
            writeCharacteristic(gattCustomService, gattWriteCharCustomService, profile.initData7_3, sizeof(profile.initData7_3),
                                QStringLiteral("init"), false, false);
            writeCharacteristic(gattCustomService, gattWriteCharCustomService, profile.initData8, sizeof(profile.initData8),
                                QStringLiteral("init"), false, false);
            writeCharacteristic(gattCustomService, gattWriteCharCustomService, profile.initData8, sizeof(profile.initData8),
                                QStringLiteral("init"), false, false);
            writeCharacteristic(gattCustomService, gattWriteCharCustomService, profile.initData9_3, sizeof(profile.initData9_3),
                                QStringLiteral("init"), false, false);
            writeCharacteristic(gattCustomService, gattWriteCharCustomService, profile.initData10_3, sizeof(profile.initData10_3),
                                QStringLiteral("init"), false, false);
            writeCharacteristic(gattCustomService, gattWriteCharCustomService, profile.initData11, sizeof(profile.initData11),
                                QStringLiteral("init"), false, false);
            writeCharacteristic(gattCustomService, gattWriteCharCustomService, profile.initData11, sizeof(profile.initData11),
        ...
        init5:
            ...
            writeCharacteristic(gattCustomService, gattWriteCharCustomService, profile.initData7_4, sizeof(profile.initData7_4),
                                QStringLiteral("init"), false, false);
            writeCharacteristic(gattCustomService, gattWriteCharCustomService, profile.initData8, sizeof(profile.initData8),
                                QStringLiteral("init"), false, false);
            writeCharacteristic(gattCustomService, gattWriteCharCustomService, profile.initData8, sizeof(profile.initData8),
                                QStringLiteral("init"), false, false);
            writeCharacteristic(gattCustomService, gattWriteCharCustomService, profile.initData9_4, sizeof(profile.initData9_4),
                                QStringLiteral("init"), false, false);
            writeCharacteristic(gattCustomService, gattWriteCharCustomService, profile.initData10_4, sizeof(profile.initData10_4),
                                QStringLiteral("init"), false, false);
            writeCharacteristic(gattCustomService, gattWriteCharCustomService, profile.initData11, sizeof(profile.initData11),
                                QStringLiteral("init"), false, false);
            writeCharacteristic(gattCustomService, gattWriteCharCustomService, profile.initData11, sizeof(profile.initData11),
        ...
        init6:
            ...
            writeCharacteristic(gattCustomService, gattWriteCharCustomService, profile.initData7_5, sizeof(profile.initData7_5),
                                QStringLiteral("init"), false, false);
            writeCharacteristic(gattCustomService, gattWriteCharCustomService, profile.initData8, sizeof(profile.initData8),
                                QStringLiteral("init"), false, false);
            writeCharacteristic(gattCustomService, gattWriteCharCustomService, profile.initData8, sizeof(profile.initData8),
                                QStringLiteral("init"), false, false);
            writeCharacteristic(gattCustomService, gattWriteCharCustomService, profile.initData9_5, sizeof(profile.initData9_5),
                                QStringLiteral("init"), false, false);
            writeCharacteristic(gattCustomService, gattWriteCharCustomService, profile.initData10_5, sizeof(profile.initData10_5),
                                QStringLiteral("init"), false, false);
            writeCharacteristic(gattCustomService, gattWriteCharCustomService, profile.initData11, sizeof(profile.initData11),
                                QStringLiteral("init"), false, false);
            writeCharacteristic(gattCustomService, gattWriteCharCustomService, profile.initData11, sizeof(profile.initData11),
        ...
        init7:
            ...
            writeCharacteristic(gattCustomService, gattWriteCharCustomService, profile.initData7_6, sizeof(profile.initData7_6),
                                QStringLiteral("init"), false, false);
            writeCharacteristic(gattCustomService, gattWriteCharCustomService, profile.initData8, sizeof(profile.initData8),
                                QStringLiteral("init"), false, false);
            writeCharacteristic(gattCustomService, gattWriteCharCustomService, profile.initData8, sizeof(profile.initData8),
                                QStringLiteral("init"), false, false);
            writeCharacteristic(gattCustomService, gattWriteCharCustomService, profile.initData9_6, sizeof(profile.initData9_6),
                                QStringLiteral("init"), false, false);
            writeCharacteristic(gattCustomService, gattWriteCharCustomService, profile.initData10_6, sizeof(profile.initData10_6),
                                QStringLiteral("init"), false, false);
            writeCharacteristic(gattCustomService, gattWriteCharCustomService, profile.initData11, sizeof(profile.initData11),
                                QStringLiteral("init"), false, false);
            writeCharacteristic(gattCustomService, gattWriteCharCustomService, profile.initData11, sizeof(profile.initData11),
                ...
                if (!horizon_paragon_x) {
                    if (horizon_treadmill_7_8) {
                        ...
                        if (!horizonPaused) { // we can't use the paused, because it's updated while we're pressing the
                            ...
                            int confirm = horizonprofile::GenerateCRC_CCITT(&write1[10], 17);
...
void horizontreadmill::forceSpeed(double requestSpeed) {
    ...
    if (gattCustomService) {
        if (!horizon_paragon_x) {
            ...
            datas[3] = 0;
            int confirm = horizonprofile::GenerateCRC_CCITT(datas, 4);
            ...
            int confirm = horizonprofile::GenerateCRC_CCITT(datas, 3);
...
void horizontreadmill::forceIncline(double requestIncline) {
    ...
    if (gattCustomService) {
        if (!horizon_paragon_x) {
            ...
            int confirm = horizonprofile::GenerateCRC_CCITT(datas, 2);
