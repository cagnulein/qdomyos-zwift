...
void iconceptbike::rfCommConnected() {
    ...
    const uint8_t init1[] = {0x55, 0x0c, 0x01, 0xff,
                             ...
                             0x55, 0x1a, 0x01, 0xff,
                             0x55, 0x1b, 0x01, 0xff};
    const uint8_t init3[] = {0x55, 0x01, 0x06, 0x2f,
                             0x00, 0x56, 0x00, 0xb7,
                             0x00, 0x55, 0xb9, 0x01,
                             0xff, 0x55, 0xb5, 0x01,
                             0xff};
    const uint8_t init4[] = {0x55, 0x17, 0x01, 0x01};
    const uint8_t init5[] = {0x55, 0x0a, 0x01, 0x02};
    const uint8_t init6[] = {0x55, 0x01, 0x06, 0x2f,
                             0x00, 0x56, 0x00, 0xb7,
                             0x00};
    const uint8_t init7[] = {0x55, 0x15, 0x01, 0x00};
    const uint8_t init8[] = {0x55, 0x0f, 0x02, 0x01,
                             0x00};
    const uint8_t init9[] = {0x55, 0x11, 0x01, 0x00};
    const uint8_t init10[] = {0x55, 0x08, 0x01, 0x01};
    ...
    qDebug() << QStringLiteral(" init4 write");
    QThread::msleep(600);
    socket->write((char *)init10, sizeof(init10));
