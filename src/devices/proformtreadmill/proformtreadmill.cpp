...
void proformtreadmill::forceIncline(double incline) {
    ...
    if (norditrack_s25i_treadmill) {
        write[14] = write[11] + write[12] + 0x11;
               ...
               proform_treadmill_8_7 || proform_carbon_tl_PFTL59720 || proform_treadmill_sport_70 || proform_treadmill_575i) {
...
//				Set treadmill speed
            ...
            uint8_t noOpData1[] = {0xfe, 0x02, 0x19, 0x03};
            uint8_t noOpData2[] = {0x00, 0x12, 0x02, 0x04, 0x02, 0x15, 0x06, 0x15, 0x02, 0x00, 0x0f, 0x80, 0x08, 0x40, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00};
            uint8_t noOpData3[] = {0xff, 0x07, 0x00, 0x00, 0x00, 0x80, 0x00, 0x10, 0x84, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00};
            uint8_t noOpData4[] = {0xfe, 0x02, 0x17, 0x03};
            uint8_t noOpData5[] = {0x00, 0x12, 0x02, 0x04, 0x02, 0x13, 0x06, 0x13, 0x02, 0x00, 0x0d, 0x3e, 0x96, 0x31, 0x00, 0x00, 0x40, 0x50, 0x00, 0x80};
            uint8_t noOpData6[] = {0xff, 0x05, 0x00, 0x00, 0x00, 0x05, 0x42, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00};
...
void proformtreadmill::characteristicChanged(const QLowEnergyCharacteristic &characteristic,
    ...
    if (newValue.length() != 20 || newValue.at(0) != 0x00 || newValue.at(1) != 0x12 || newValue.at(2) != 0x01 ||
        ...
        ((proform_treadmill_575i) && (newValue.at(4) != 0x02 || (newValue.at(5) != 0x2d))) ||
        ...
        ((nordictrack_t65s_treadmill || proform_pro_1000_treadmill || nordictrack_t65s_83_treadmill || nordictrack_s30_treadmill ||
          ...
          nordictrack_s20i_treadmill || proform_treadmill_8_7 || proform_carbon_tl_PFTL59720) &&
...
void proformtreadmill::btinit() {
    ...
    if (nordictrack10) {
        ...
        uint8_t initData10[] = {0x00, 0x12, 0x02, 0x04, 0x02, 0x28, 0x06, 0x28, 0x90, 0x07, 0x01, 0x6d, 0xe8, 0x69, 0xe8, 0x75, 0xf0, 0x89, 0x00, 0x9d};
        uint8_t initData11[] = {0x01, 0x12, 0x28, 0xb9, 0x48, 0xd5, 0x60, 0x19, 0xb0, 0x2d, 0xc8, 0x69, 0x08, 0xd5, 0x70, 0x09, 0xa0, 0x7d, 0x08, 0xd9};
        uint8_t initData12[] = {0xff, 0x08, 0x68, 0x35, 0xc0, 0x98, 0x02, 0x00, 0x00, 0xc7, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00};
        uint8_t noOpData1[] = {0xfe, 0x02, 0x19, 0x03};
        ...
        uint8_t noOpData7[] = {0x00, 0x12, 0x02, 0x04, 0x02, 0x15, 0x06, 0x15, 0x02, 0x00, 0x0f, 0x00, 0x10, 0x00, 0xd8, 0x1c, 0x4c, 0x00, 0x00, 0xe0};
        uint8_t noOpData8[] = {0xff, 0x07, 0x00, 0x00, 0x00, 0x10, 0x00, 0x08, 0x74, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00};
        ...
        writeCharacteristic(noOpData2, sizeof(noOpData2), QStringLiteral("init"), false, false);
        QThread::msleep(sleepms);
        writeCharacteristic(noOpData3, sizeof(noOpData3), QStringLiteral("init"), false, true);
        QThread::msleep(sleepms);
        writeCharacteristic(noOpData4, sizeof(noOpData4), QStringLiteral("init"), false, false);
        QThread::msleep(sleepms);
        writeCharacteristic(noOpData5, sizeof(noOpData5), QStringLiteral("init"), false, false);
        QThread::msleep(sleepms);
        writeCharacteristic(noOpData6, sizeof(noOpData6), QStringLiteral("init"), false, true);
        QThread::msleep(sleepms);
        writeCharacteristic(noOpData1, sizeof(noOpData1), QStringLiteral("init"), false, false);
        QThread::msleep(sleepms);
        writeCharacteristic(noOpData7, sizeof(noOpData7), QStringLiteral("init"), false, false);
        QThread::msleep(sleepms);
        writeCharacteristic(noOpData8, sizeof(noOpData8), QStringLiteral("init"), false, true);
        QThread::msleep(sleepms);
    } else if (proform_treadmill_8_7) {
        uint8_t initData1[] = {0xfe, 0x02, 0x08, 0x02};
        writeCharacteristic(initData1, sizeof(initData1), QStringLiteral("init"), false, false);
