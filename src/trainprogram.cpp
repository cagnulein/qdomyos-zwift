    ...
    if (ticks == 1 && currentStep == 0) {
        ...
        if (bluetoothManager->device()->deviceType() == bluetoothdevice::TREADMILL) {
            ...
            if (rows.at(0).inclination != -200 && bluetoothManager->device()->deviceType() == bluetoothdevice::BIKE) {
                ...
                double bikeResistanceOffset = settings.value(QZSettings::bike_resistance_offset, QZSettings::default_bike_resistance_offset /* 0 */).toInt();
                double bikeResistanceGain = settings.value(QZSettings::bike_resistance_gain_f, QZSettings::default_bike_resistance_gain_f /* 1 */).toDouble();
                ...
                if (bluetoothManager->device()->deviceType() == bluetoothdevice::TREADMILL) {
                    ...
                    if (rows.at(currentStep).inclination != -200 &&
                        ...
                        double bikeResistanceOffset =
                            settings.value(QZSettings::bike_resistance_offset, QZSettings::default_bike_resistance_offset /* 0 */).toInt();
                        double bikeResistanceGain =
                            settings.value(QZSettings::bike_resistance_gain_f, QZSettings::default_bike_resistance_gain_f /* 1 */).toDouble();
