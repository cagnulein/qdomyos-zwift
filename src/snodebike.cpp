...
/*
void snodebike::writeCharacteristic(uint8_t* data, uint8_t data_len, QString info, bool disable_log, bool wait_for_response)
{
    QEventLoop loop;
    QTimer timeout;
...
void* snodebike::VirtualBike()
{
    return virtualBike;
}

void* snodebike::VirtualDevice()
{
    return VirtualBike();
}
