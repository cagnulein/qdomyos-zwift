/****************************************************************************
** Meta object code from reading C++ file 'solebike.h'
**
...
#error "The header file 'solebike.h' doesn't include <QObject>."
...
struct qt_meta_stringdata_solebike_t {
    QByteArrayData data[29];
    char stringdata0[467];
};
#define QT_MOC_LITERAL(idx, ofs, len) \
    Q_STATIC_BYTE_ARRAY_DATA_HEADER_INITIALIZER_WITH_OFFSET(len, \
    qptrdiff(offsetof(qt_meta_stringdata_solebike_t, stringdata0) + ofs \
        - idx * sizeof(QByteArrayData)) \
    )
static const qt_meta_stringdata_solebike_t qt_meta_stringdata_solebike = {
    {
QT_MOC_LITERAL(0, 0, 8), // "solebike"
...
QT_MOC_LITERAL(28, 435, 31) // "QLowEnergyService::ServiceError"
    ...
    "solebike\0disconnected\0\0deviceDiscovered\0"
...
static const uint qt_meta_data_solebike[] = {
...
void solebike::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        auto *_t = static_cast<solebike *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
        ...
        {
            using _t = void (solebike::*)();
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&solebike::disconnected)) {
                *result = 0;
                return;
            }
        }
...
QT_INIT_METAOBJECT const QMetaObject solebike::staticMetaObject = { {
    QMetaObject::SuperData::link<bike::staticMetaObject>(),
    qt_meta_stringdata_solebike.data,
    qt_meta_data_solebike,
    qt_static_metacall,
    nullptr,
    nullptr
} };
...
const QMetaObject *solebike::metaObject() const
{
    return QObject::d_ptr->metaObject ? QObject::d_ptr->dynamicMetaObject() : &staticMetaObject;
}

void *solebike::qt_metacast(const char *_clname)
{
    if (!_clname) return nullptr;
    if (!strcmp(_clname, qt_meta_stringdata_solebike.stringdata0))
        return static_cast<void*>(this);
    return bike::qt_metacast(_clname);
}

int solebike::qt_metacall(QMetaObject::Call _c, int _id, void **_a)
{
