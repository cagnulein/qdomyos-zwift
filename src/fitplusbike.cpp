...
int fitplusbike::pelotonToBikeResistance(int pelotonResistance)
{
...
uint8_t fitplusbike::resistanceFromPowerRequest(uint16_t power)
{
...
QTime fitplusbike::GetElapsedFromPacket(QByteArray packet)
{
...
double fitplusbike::GetDistanceFromPacket(QByteArray packet)
{
